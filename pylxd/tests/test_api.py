...
class Test_APINode(unittest.TestCase):
    """Tests for pylxd.connection._APINode."""
    ROOT = 'http://lxd/api'

    def test_getattr(self):
        """`__getattr__` returns a nested node."""
        lxd = connection._APINode(self.ROOT)
    ...
    def test_getattr_nested(self):
        ...
        lxd = connection._APINode(self.ROOT)  # NOQA
    ...
    @mock.patch('pylxd.connection.requests.get')
    ...
    @mock.patch('pylxd.connection.requests.post')
    ...
    @mock.patch('pylxd.connection.requests.put')
    ...
    @mock.patch('pylxd.connection.requests.delete')
